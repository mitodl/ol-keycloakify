            ...
            <EmailLayout preview={`Invitation to join MIT Learn`} locale={locale}>
                <Text style={paragraph}>
                    ...
                    <p>
                        ...
                        <span style={emphasizedText}>MIT Learn</span>. This platform
                        provides access to MIT Learn&apos;s educational resources and
                        course materials.
                    </p>

                    <p>
                        As a member of MIT Learn, you&apos;ll be able to access courses,
                        tutorials, and learning materials designed to enhance your
                    ...
                    <p>
                        If you did not expect this invitation or have any questions,
                        please contact the MIT Learn support team.
                    </p>

                    <p style={{ marginTop: "30px", fontSize: "14px", color: "#777" }}>
                        If you&apos;re unable to click the button above, copy and paste
                    ...
                    >
                        This is an automated message from MIT Learn. Please do not reply
                        to this email.
                    </p>
                </Text>
            </EmailLayout>
        ...
        return (
            ...
            >
                <Text style={paragraph}>
                    ...
                    <p>
                        You have been invited to join{" "}
                        <span style={emphasizedText}>
                            MIT Open Learning Data Platform
                        </span>
                        . This platform provides tools for data analysis and insights into
                        learning patterns across MIT&apos;s courses.
                    </p>

                    <p>
                        As a data platform user, you&apos;ll have access to analytics
                        dashboards, research datasets, and collaboration tools designed
                        for educational data science.
                    </p>

                    <p>
                        To accept this invitation and begin working with the platform,
                    ...
                    <p>
                        If you have questions about data usage policies or technical
                        requirements, please contact the platform administration team.
                    </p>
                    ...
                    >
                        This is an automated message from MIT Open Learning Data Platform.

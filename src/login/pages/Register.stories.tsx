...
export const WithRestrictedToMITEmail: Story = {
    render: () => (
        <KcPageStory
            kcContext={{
                profile: {
                ...
                "x-keycloakify": {
                    messages: {
                        "profile.attributes.email.inputHelperTextBefore": "Please use your MIT email.",
                        "profile.attributes.email.pattern.error": "This is not an MIT (<strong>@mit.edu</strong>) email."
                    }
                }
            }}
        />
